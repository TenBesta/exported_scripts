# encoding: utf8
# [119] 31330595: Core Script Yanfly
#==============================================================================
#
...
module YEA
  module CORE
    ...
    #=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    FONT_NAME = ["Agency FB", "Verdana", "Arial", "Courier"]
    ...
    FONT_COLOUR = Color.new(0, 255, 255, 255)   # Default: 255, 255, 255, 255
    ...
    # :text       => ID
      :normal     => 15,   # Default:  0
      :system     => 15,   # Default: 16
      :crisis     => 17,   # Default: 17
      :knockout   => 18,   # Default: 18
      :gauge_back => 19,   # Default: 19
      :hp_gauge1  => 18,   # Default: 20
      :hp_gauge2  => 10,   # Default: 21

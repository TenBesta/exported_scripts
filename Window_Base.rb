...
class Window_Base < Window
  ...
  # * Get Text Colors
  #--------------------------------------------------------------------------
  def normal_color;      text_color(20);   end;    # Normal
  def system_color;      text_color(31);  end;    # System
  ...
  def hp_gauge_color1;   text_color(5);  end;    # HP gauge 1
